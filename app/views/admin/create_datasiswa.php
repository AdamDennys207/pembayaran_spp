                ...
                <div class="container-fluid">
                    ...
                    <form action="<?= BASEURL; ?>/admin/insertSiswa" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="pass" id="inputnama">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="examplenis">Id Pengguna</label>
                                <select class="form-control" name="pengguna_id" id="inputidpengguna">
                                    <?php foreach($data['siswa'] as $siswa):?>
                                        <option value="<?=$siswa['pengguna_id']?>"><?=$siswa['pengguna_id']?></option>
                                    <?php endforeach;?>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="examplenis"></label>
